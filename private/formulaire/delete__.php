...
{
// $reponse = $db->query("SELECT acteur, poste, montant_sem, montant_mois, montant_annee FROM echeancier_entree WHERE id=$id");
// while ($donnees = $reponse->fetch()){
	 ...
	 // $question = "Acteur: $acteur,<br />Poste: $poste,<br />Montant: $montant_sem $montant_mois $montant_annee € ?";
